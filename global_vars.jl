...
const spawn_dim_x::Float64 = 200.0 #This gives the x dimesnion size of the initial spawning area for the agents
const spawn_dim_y::Float64 = 200.0 #This gives the y dimension size of the initial spawning area for the agents
