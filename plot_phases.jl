...
Makie.bracket!(lower_ax1,  (10*sqrt(12)/offset), 0.1, (100*sqrt(12)), 0.1, text = "Solid", style = :curly)
Makie.bracket!(lower_ax1,  (100*sqrt(12)), 0.1, (2000*sqrt(12)), 0.1, text = "Swarm", style = :curly)
#Makie.bracket!(lower_ax1, log10(2000*sqrt(12)), 0.1, log10(20000*sqrt(12)), 0.1, text = "Gas", style = :curly)
Makie.bracket!(lower_ax1, (2000*sqrt(12)), 0.1, (20000*sqrt(12)/offset), 0.1, text = "Diffusive", style = :curly)
resize_to_layout!(f)
