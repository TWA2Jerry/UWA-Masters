...
#model = initialise(target_area_arg = 100.0, simulation_number_arg = 1, no_bird = no_birds, area_args = (1*sqrt(12), 1000.0*sqrt(12)), left_bias_arg = 0.5)
