...
parameters = Dict(
        ...
        :area_args => [(1*sqrt(12), 1000*sqrt(12))],
	:no_bird => no_birds_vec
	#:target_area_arg => target_dods,
	#:left_bias_arg => left_biases	
)

model = initialise(target_area_arg = 100.0, simulation_number_arg = 1, no_bird = no_birds, area_args = (1000*sqrt(12), 2500*sqrt(12)), left_bias_arg = 0.5)
