...
lower_upper_areas = [(1*sqrt(12), 4000*sqrt(12))]
q_args = [8]
m_args = [10]
qp_args = [1]
fov_args = [180.0]
...
#model = initialise(target_area_arg = 100.0, simulation_number_arg = 1, no_bird = no_birds, area_args = (1*sqrt(12), 1500*sqrt(12)), left_bias_arg = 0.5)
