...
#sampled_cell = give_cell_forward(model[1].pos, positions, model, model[1].vel, relic_half_plane, relic_passed = 1, rhop = 1000.0)
...
#Makie.arc!(model[1].pos, 100.0, -pi, pi; transparency = true, color = (:red, 0.4))
