...
###Given a cell, circle it. 
function give_cell_circled(cell, pos)
...
function give_agent_cell_circled(agent_i, model)
        all_agents_iterable =  allagents(model)
        temp_hp::Vector{Tuple{Float64, Tuple{Float64, Float64}, Tuple{Float64, Float64}, Int64}} = []
                ...
                uncircled_cell = give_cell(agent_i.pos, neighbour_positions, model)
