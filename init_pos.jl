...
function init_thesis(cellx, celly, no_agents, spacexspan, spaceyspan, offsetx, offsety, initial_positions, initial_vels)
	...
	push!(initial_positions, ro .+ (0.5, 1.0))
	#push!(initial_positions, ro .+ (cos(2*pi/3)*130, sin(2*pi/3)*130) .* 0.1)
	#push!(initial_positions, ro .+ (160.0, 0.0) .* 0.1)
	#push!(initial_positions, ro .+ (cos(60*pi/180)*160, sin(60*pi/180)*160) .* 0.1)
	#push!(initial_positions, ro .+ (cos(3*pi/4)*190, sin(3*pi/4)*190) .* 0.1)
	#push!(initial_positions, ro .+ (cos(85*pi/180)*180, sin(85*pi/180)*180) .* 0.1)	
...
function init_thesis_2(cellx, celly, no_agents, spacexspan, spaceyspan, offsetx, offsety, initial_positions, initial_vels)
	ro::Tuple{Float64, Float64} = (rect_bound/2, rect_bound/2)
	push!(initial_positions, ro)
